...
export default function EditProfile(props: Props) {
  ...
  const [username, setUsername] = useState(props.player.user.username);
  ...
  const [editPlayerHandler] = useMutation(editPlayerMutation, {
    ...
    onCompleted: () => {
      ...
      setRepeatPassword('');
      setOpen(false);
      router.push(`/players/${encodeString(alias.toLowerCase())}`);
    },
  });
